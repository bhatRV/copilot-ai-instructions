Prefix every commit message with the Jira ticket number extracted from the current branch name. The ticket format is `XAAS-<digits>` (e.g., `XAAS-1234`). Use the format: `XAAS-1234: <commit message>`.
...
```
XAAS-1234: fix null pointer in claims lookup
